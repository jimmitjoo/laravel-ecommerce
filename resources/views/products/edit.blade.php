                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="number" min="0.00" max="9999999.00" name="price" id="price" value="{{ $product->price }}">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="name" type="text" name="name" placeholder="{{ __('products.name') }}" value="{{ $product->name }}">
                            </div>

                            <div class="form-group">
                                <textarea class="form-control" name="description" id="description" rows="5" placeholder="{{ __('products.description') }}">{{ $product->description }}</textarea>
                            </div>
